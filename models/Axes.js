class Axes {
  constructor (gl) {
    ...
    this.xaxis = new TruncCone(gl, 0.03, 0.03, 0.9, 20, 5, xcolor, xcolor);
    this.yaxis = new TruncCone(gl, 0.03, 0.03, 0.9, 20, 5, ycolor, ycolor);
    this.zaxis = new TruncCone(gl, 0.03, 0.03, 0.9, 20, 5, zcolor, zcolor);
