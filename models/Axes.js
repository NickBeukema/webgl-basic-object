class Axes {
  constructor (gl) {
    ...
    let axisRadius = 0.003;


    this.xaxis = new TruncCone(gl, axisRadius, axisRadius, 0.9, 20, 5, xcolor, xcolor);
    this.yaxis = new TruncCone(gl, axisRadius, axisRadius, 0.9, 20, 5, ycolor, ycolor);
    this.zaxis = new TruncCone(gl, axisRadius, axisRadius, 0.9, 20, 5, zcolor, zcolor);
