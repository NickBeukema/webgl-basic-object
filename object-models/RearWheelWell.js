class RearWheelWell extends BasicShape {
  /**
  ...
  constructor (gl) {
    ...
    mat4.scale(wheelWellBackScale, wheelWellBackScale, vec3.fromValues(0.74, 0.01, 0.24));
    mat4.translate(wheelWellBackTranslate, wheelWellBackTranslate, vec3.fromValues(0.05, -0.03, -0.057));
    ...
    mat4.translate(wheelWellFrontTranslate, wheelWellFrontTranslate, vec3.fromValues(-0.1, -0.014, -0.057));
    ...
    mat4.translate(wheelWellRearTranslate, wheelWellRearTranslate, vec3.fromValues(0.191, -0.014, -0.057));
    ...
    mat4.scale(wheelWellTopScale, wheelWellTopScale, vec3.fromValues(0.72, 0.07, 0.01));
    mat4.translate(wheelWellTopTranslate, wheelWellTopTranslate, vec3.fromValues(0.045, -0.014, -0.01));
